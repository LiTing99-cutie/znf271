...
.mask(cnt.iloc[:,1]==3,"3")
.mask(cnt.iloc[:,1]==1,"1"))
cnt.new.value_counts().to_csv("/home/user/data2/lit/project/ZNF271/02-APA-1/output/final_list/n_pas.txt",header=0,sep='\t')
fo=open("/home/user/data2/lit/project/ZNF271/02-APA-1/output/final_list/pa_isoforms.txt","w")
...
# %%
# pd.concat([tmp[1],tmp[0]],axis=0).to_csv("/home/user/data2/lit/project/ZNF271/02-APA-1wo/annotation/terminal_exon/terminal_exon_annotation.txt",sep="\t",header=0,index=0)
