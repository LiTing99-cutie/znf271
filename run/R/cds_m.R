...
PA_site <- fread("/home/user/data2/lit/project/ZNF271/02-APA-1/evolution-diff/clean/m/PAusage.type_II_III.fil.bed6+")
colnames(PA_site) <- c("chr","start","end","gene_name","count","strand")

# cds length
cds=fread("/home/user/data2/lit/project/ZNF271/02-APA-1/annotation/mouse/cds_l_transcript_l_ensembl_98_m.txt",header = TRUE)
...
info <- read.table("/home/user/data2/lit/project/ZNF271/02-APA-1/evolution-diff/clean/m/t_id_chr_str_t_s_e_cds_s_e_gene_name.txt")
...
fwrite(tmp,file ="/home/user/data2/lit/project/ZNF271/02-APA-1/evolution-diff/clean/m/cds_type_pa_count.txt" )
