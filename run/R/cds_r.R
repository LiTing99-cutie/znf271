...
PA_site <- fread("/home/user/data2/lit/project/ZNF271/02-APA-1/evolution-diff/PAusage.type_II.fil.r.bed6+")
colnames(PA_site) <- c("chr","start","end","gene_name","count","strand")

# cds length
cds=fread("/home/user/data2/lit/project/ZNF271/02-APA-1/evolution-diff/type_II.cds_l_transcript_l.r.txt",header = TRUE)
...
info <- read.table("/home/user/data2/lit/project/ZNF271/02-APA-1/evolution-diff/t_id_chr_str_t_s_e_cds_s_e_gene_name.r.txt")
