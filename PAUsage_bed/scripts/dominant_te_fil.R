...
if(is.na(args[1])){
  args <- c()
  args[1] <- "/home/user/data2/lit/project/ZNF271/02-APA-1/PAUsage_bed/output/do_te_inter_other_trans.bed"
  args[2] <- "/home/user/data2/lit/project/ZNF271/02-APA-1/PAUsage_bed/output/do_te.bed"
  args[3] <- "/home/user/data2/lit/project/ZNF271/02-APA-1/PAUsage_bed/output/do_te_per.bed"
  args[4] <- "/home/user/data2/lit/project/ZNF271/02-APA-1/PAUsage_bed/output"
}

# read in
do_te_inter_other_trans <- fread(args[1])
do_te <- fread(args[2])
do_te_per <- fread(args[3])

# fil
do_te_inter_other_trans$V9-do_te_inter_other_trans$V3 >=0 & do_te_inter_other_trans$V2-do_te_inter_other_trans$V8>=0 -> idx
do_te_inter_other_trans[!idx] -> do_te_inter_other_trans_fil
do_te_inter_other_trans_fil %>% distinct(V4) -> fil_gene
