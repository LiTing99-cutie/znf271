...
### get fasta ###
nohup ipython -c "%run $script_path/get_fasta.ipynb --input_file to_predict_gene_id.txt --output_path cdna" &
#
...
nohup ipython -c "%run $script_path/cds_p_to_genomic_p.ipynb" &
#
