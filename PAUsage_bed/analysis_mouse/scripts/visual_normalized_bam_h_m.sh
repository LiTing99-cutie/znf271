...
# /home/user/data/lit/project/ZNF271/data/rna-seq/brain/mapping/brain/uniq/ \
# output/visual_n_bam \
# /home/user/data/lit/project/ZNF271/visual_n_bam \
# /home/user/data3/lit/project/ZNF271/data/rna-seq/brain/metadata/human" &>log/visual_normalized_bam_human.log
