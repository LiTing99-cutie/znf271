...
# change cutoff
c_cutoff <- function(df,cutoff){
  df <- filter(df,cnt>=cutoff)
  return(df)
}
h <- c_cutoff(h,10)
r <- c_cutoff(r,10)
...
# fwrite
fwrite(res_df,file = "/home/user/data2/lit/project/ZNF271/02-APA-1/analysis/evo_compare/skewness_solu_1_evo_raw_s_cutoff_10.txt")
