...
# read data in 
h <- fread("/home/user/data2/lit/project/ZNF271/02-APA-1/analysis/evo_compare/h/h.cnt.rn.bed")
r <- fread("/home/user/data2/lit/project/ZNF271/02-APA-1/analysis/evo_compare/r/r.cnt.rn.bed")
m <- fread("/home/user/data2/lit/project/ZNF271/02-APA-1/analysis/evo_compare/m/m.cnt.rn.bed")
max_len <- fread("/home/user/data2/lit/project/ZNF271/02-APA-1/analysis/evo_compare/max_len.txt")
...
# fwrite
fwrite(res_df,file = "/home/user/data2/lit/project/ZNF271/02-APA-1/analysis/evo_compare/skewness_solu_1_evo_raw.txt")
